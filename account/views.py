...
from .forms import UserRegisterForm , VerifyCodeForm , UserLogin
    ...
    def post(self,request):
        ...
        if form.is_valid():
            ...
            if user :
                ...
                return redirect('home:home')
            messages.error(request,'your phone or password was wrong.','info')
        return render(request,self.template_name,{'form':form})
...
class UserLogoutView(LoginRequiredMixin,View):
    def get(self,request):
        logout(request)
        messages.success(request,'logout successfully.','info')
        return redirect('home:home')